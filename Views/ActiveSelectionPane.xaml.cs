...
namespace Views
{
    public partial class ActiveSelectionPane : Window
    {
        public ActiveSelectionPane()
        {
            InitializeComponent();
        }
        ...
        public void SitBehind(IntPtr handle)
        {
            var wndHelper = new WindowInteropHelper(this);
            var priorWindow = GetWindow(handle, 2);
            //SetWindowPos(wndHelper.Handle, priorWindow, 0, 0, 0, 0, SWP_NOSIZE | SWP_NOMOVE | SWP_NOACTIVATE);
        }
